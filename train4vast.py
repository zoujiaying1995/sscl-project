...
class Instructor:
    ...
    def _train(self, criterion, unitedCL_criterion, optimizer):
        ...
        for epoch in range(self.opt.num_epoch):
            ...
            for i_batch, sample_batched in enumerate(self.train_data_loader):
                ...
                targets = sample_batched[self.opt.col_map['stances']].to(self.opt.device)  # 立场标签
    ...
    def run(self, repeats=1):
        ...
        for i in range(repeats):
            ...
            self.model = opt.model_class(opt).to(opt.device)  # reset model
            params = [
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='zeroshot_vast', type=str, help='zeroshot_vast, fewshot_vast')
    ...
    parser.add_argument('--cl_alpha', default=0.5, type=float)  # sentiment_cl weight
    parser.add_argument('--cl_beta', default=0.5, type=float)  # stance_cl weight
    parser.add_argument('--gama', default=1.0, type=float)  # stance_cl weight
    parser.add_argument('--maxlen', default=128, type=int)  # tokenizer maxlen
    parser.add_argument('--isCL', default=False, type=bool)
    ...
    # dataloader return :targets, texts, stances, sentiments, united_labels, input_idss,attention_masks,token_type_idss
